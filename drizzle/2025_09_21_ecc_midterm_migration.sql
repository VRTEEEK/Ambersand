-- ECC Mid-term Migration to Generic Regulations Model
-- Created: 2025-09-21
...
-- Note: Most columns already exist in your schema, but adding IF NOT EXISTS for safety
...
DO $
BEGIN
  -- Add regulationControlId to task_controls if it exists
  ...
  -- Add regulationControlId to evidence_controls if it exists
