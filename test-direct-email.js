...
const msg = {
  ...
  subject: 'Task Assignment Notification - Test',
  html: `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="background: #f3f4f6; padding: 15px; border-radius: 8px; margin: 20px 0;">
        ...
        <p style="margin: 5px 0;"><strong>Project:</strong> Email Testing</p>
        <p style="margin: 5px 0;"><strong>Due Date:</strong> Today</p>
        <p style="margin: 5px 0;"><strong>Priority:</strong> High</p>
      </div>
      <p>Please log in to the Ambersand platform to view and manage this task.</p>
